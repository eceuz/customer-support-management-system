...
import Yazarkasalar from "../components/Yazarkasalar";
...
function Ayarlar() {
  ...
  const menuItems = [

    {
      id: "musteriler",
      label: "Müşteriler",
      desc: "Müşteri kayıtlarını yönetin",
      icon: <PeopleIcon />
    },
...

    {
      id: "kullanicilar",
      label: "Kullanıcılar",
      desc: "Kullanıcı hesaplarını yönetin",
      icon: <PersonIcon />
    },
